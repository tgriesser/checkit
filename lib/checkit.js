...
var _marked = [validationRunner].map(regeneratorRuntime.mark);
...
var Checkit = function () {
  ...
  _createClass(Checkit, [{
    ...
    value: function run(target, context) {
      return asyncValidationRunner(this, target, context).then(function (result) {
...
function checkit() {
  return new (Function.prototype.bind.apply(Checkit, [null].concat(Array.prototype.slice.call(arguments))))();
}
...
function validationRunner(checkit, target) {
  ...
  var conditional, options, validations, single, failFast, validated, errors, addError, valKeys, i, l, key, validationItems, i2, l2, validation, passed, _i, _l, result, _conditional$_i, predicate, validate, c, val;

  return regeneratorRuntime.wrap(function validationRunner$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          addError = function addError(key, _ref) {
            var message = _ref.message;
            var label = _ref.label;
            var params = _ref.params;

            var msg = formatMessage(label, message, params);
        ...
        case 60:
          ...
          return _context.delegateYield(isAsync ? asyncValidationRunner(c, target, context) : validationRunner(c, target, context), 't2', 62);
  ...
  }, _marked[0], this, [[16, 26], [48, 54, 57, 68]]);
}

var asyncValidationRunner = co.wrap(regeneratorRuntime.mark(function _callee(checkit, target, context) {
