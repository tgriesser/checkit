...
function validationRunner(checkit, target) {
  ...
  return regeneratorRuntime.wrap(function validationRunner$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          addError = function addError(key, obj, e) {
            var message = obj.message;
            var label = obj.label;
            var params = obj.params;

            var msg = e ? e.message : formatMessage(label, message, params);
            errors[key] = errors[key] || new FieldError(msg, key, single);
            var valError = new ValidationError(msg);
        ...
        case 60:
          ...
          return _context.delegateYield(asyncValidationRunner(c, target, context), 't3', 63);
        ...
        case 66:
          return _context.delegateYield(validationRunner(c, target, context), 't4', 67);
  ...
  }, _marked[0], this, [[16, 26], [48, 54, 57, 73]]);
}
