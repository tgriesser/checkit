module.exports = {
  ...
  messages: {
    ...
    minLength: 'Le champ {{label}} doit avoir une longueur minimum de {{var_1}} charactères',
    ...
    ipv4: 'Le champ {{label}} doit être une chaine IPv4 valide',
    ipv6: 'Le champ {{label}} doit être une adresse IPv6 valide',
    base64: 'Le champ {{label}} doit être une chaine en base64',
